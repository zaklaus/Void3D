...
class C_loader_i3d: public C_loader{
private:
   struct S_vertex {
      S_vector xyz;
      S_vector normal;
...
public:
   ...
   I3D_RESULT CreateTexture(dword ct_flags, const S_mat_src& mat_src, const char* mat_name,
      PI3D_material mat, I3D_MATERIAL_TEXTURE_INDEX mti, const C_str* opt = NULL) {
   ...
   I3D_RESULT SetupMaterial(PI3D_material mat, dword ct_flags, dword txt_flags,
...
//verts.erase(verts.begin() + new_vertex_count, verts.end());
   ...
   bool AssignUVCoordinates(C_vector<word>& in_vertex_map, C_vector<S_vertex>& in_verts, C_vector<I3D_triface>& faces,
   ...
   I3D_RESULT ReadMesh(PI3D_frame frm, PI3D_mesh_base mesh, const char* name, bool& allow_cache) {
...
//ck.Read(&num_faces, sizeof(word));
   ...
   I3DENUMRET BuildSectors(PI3D_frame frm, PI3D_scene scene, PI3D_model model) override{
...
public:
   C_loader_i3d(PI3D_driver d, C_chunk& ck_in) :
      C_loader(d, ck_in),
      anim_length(0)
   {}
};
